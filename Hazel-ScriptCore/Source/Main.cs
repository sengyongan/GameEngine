...
namespace Hazel
{
    ...
    public static class InternalCalls//内部调用
    {
        [MethodImplAttribute(MethodImplOptions.InternalCall)]//方法模板属性【方法模板选项.内部调用】特性
    ...
    public class Entity
    {
        ...
        public void PrintMessage()//c++调用c#
        {
        ...
        private void Log(string text, int parameter)//c#调用c++
        {
